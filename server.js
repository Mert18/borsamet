...
client.on('ready', () => {
    ...
    setInterval(async () => {
        ...
        const res = await axios.get("https://api.nomics.com/v1/currencies/ticker?key=" + process.env.NOMICS_API_KEY + "&ids=BTC,ETH,CHZ,KAVA,SXP,TRYB&interval=1d,30d&convert=USDT&per-page=100&page=1")
            .then(response => {
